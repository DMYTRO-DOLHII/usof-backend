...
const { validateToken, authorizeCommentCreator, authorizeReplyCreator } = require('../middlewares/middleware.auth');
...
router.delete('/:reply_id/reply', validateToken, authorizeReplyCreator, commentController.deleteReply);
